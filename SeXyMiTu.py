...
def back():
    login()
def contact():
    os.system('xdg-open https://www.facebook.com/Jihadvai009')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
logo =(f                                                                                                 
          ...
          JJJJJJJJJJJIIIIIIIIIIHHHHHHHHH     HHHHHHHHH               AAA               DDDDDDDDDDDDD        
          J:::::::::JI::::::::IH:::::::H     H:::::::H              A:::A              D::::::::::::DDD     
          J:::::::::JI::::::::IH:::::::H     H:::::::H             A:::::A             D:::::::::::::::DD   
          JJ:::::::JJII::::::IIHH::::::H     H::::::HH            A:::::::A            DDD:::::DDDDD:::::D  
            J:::::J    I::::I    H:::::H     H:::::H             A:::::::::A             D:::::D    D:::::D 
            J:::::J    I::::I    H:::::H     H:::::H            A:::::A:::::A            D:::::D     D:::::D
            J:::::J    I::::I    H::::::HHHHH::::::H           A:::::A A:::::A           D:::::D     D:::::D
            J:::::j    I::::I    H:::::::::::::::::H          A:::::A   A:::::A          D:::::D     D:::::D
            J:::::J    I::::I    H:::::::::::::::::H         A:::::A     A:::::A         D:::::D     D:::::D
JJJJJJJ     J:::::J    I::::I    H::::::HHHHH::::::H        A:::::AAAAAAAAA:::::A        D:::::D     D:::::D
J:::::J     J:::::J    I::::I    H:::::H     H:::::H       A:::::::::::::::::::::A       D:::::D     D:::::D
J::::::J   J::::::J    I::::I    H:::::H     H:::::H      A:::::AAAAAAAAAAAAA:::::A      D:::::D    D:::::D 
J:::::::JJJ:::::::J  II::::::IIHH::::::H     H::::::HH   A:::::A             A:::::A   DDD:::::DDDDD:::::D  
 JJ:::::::::::::JJ   I::::::::IH:::::::H     H:::::::H  A:::::A               A:::::A  D:::::::::::::::DD   
   JJ:::::::::JJ     I::::::::IH:::::::H     H:::::::H A:::::A                 A:::::A D::::::::::::DDD     
     JJJJJJJJJ       IIIIIIIIIIHHHHHHHHH     HHHHHHHHHAAAAAAA                   AAAAAAADDDDDDDDDDDDD        
...
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mDeveloper \033[1;31m● \x1b[38;5;46mJIHAD VAW
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mFacebook  \033[1;31m● \x1b[38;5;46mmRefresh Jihad
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/J1H4D-2-0/MITUxCLON/blob/main/Mitu99.txt').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+601151104704?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
#while attemps < 12345677901:
 #     username = input('\033[1;91m[\033[1;92m√\033[1;91m]\x1b[38;5;50m ENTER USERNAME: ')
  ...
  #  if username == 'JIHAD' and password == '007':
...
def menu():
    ...
    if ARAFAT in ['111']:
        ...
        os.system('xdg-open https://github.com/J1H4D-2-0')
        os.system("python nono.py")
    elif ARAFAT in ['3','03']:
        result()
    elif ARAFAT in ['0']:
